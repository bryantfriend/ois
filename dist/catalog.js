...
const FORMATS = {
 ...
 board:{name:'Challenge Board',icon:'▦',description:'Pick a point tile and reveal a classroom challenge.',instructions:'Teams alternate choosing unused tiles. Discuss the answer, reveal the model answer, and let the teacher mark the response. Higher tiles are worth more points; they are not automatically harder.'},
