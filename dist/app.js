...
function current(){if(game.lesson.format==='boozled'&&game.session){const card=game.session.deck[game.session.active];return card?.question!==undefined?game.items[card.question]:undefined;}return game.items[game.index];}
